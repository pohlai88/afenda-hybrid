 ...
 */
export const auditSummary = auditSchema.materializedView("mv_audit_summary", {
  // Dimensions
 ...
 */
export const actorActivitySummary = auditSchema.materializedView("mv_actor_activity", {
  // Dimensions
  tenantId: integer().notNull(),
  actorId: integer(),
  actorType: actorTypeEnum().notNull(),
 ...
 */
export const tenantAuditOverview = auditSchema.materializedView("mv_tenant_audit_overview", {
  tenantId: integer().notNull(),
