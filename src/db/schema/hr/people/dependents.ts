...
import { persons, genderEnum } from "./persons";
...
export const dependentRelationshipZodEnum = createSelectSchema(dependentRelationshipEnum);
...
export const dependentStatusZodEnum = createSelectSchema(dependentStatusEnum);
