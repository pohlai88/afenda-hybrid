...
export const reportTypeZodEnum = createSelectSchema(reportTypeEnum);
...
export const reportingLines = hrSchema.table(
  ...
  (t) => [
    ...
    check(
      "chk_reporting_lines_not_self",
      sql`${t.employeeId} != ${t.managerId}`
    ),
  ]
);
...
export const reportingLineInsertSchema = createInsertSchema(reportingLines);
