...
export const jobFamilyStatusZodEnum = createSelectSchema(jobFamilyStatusEnum);
...
export const jobFamilyInsertSchema = createInsertSchema(jobFamilies, {
  familyCode: z.string().min(2).max(50).regex(/^[A-Z0-9_-]+$/i, "Only alphanumeric, underscore, and hyphen allowed"),
