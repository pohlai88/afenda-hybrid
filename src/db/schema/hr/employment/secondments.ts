 ...
 * Circular FK note: employeeId, department, location, legalEntity FKs added via custom SQL.
 */
export const secondmentStatuses = ["PENDING", "ACTIVE", "COMPLETED", "CANCELLED", "EXTENDED"] as const;

export const secondmentStatusEnum = hrSchema.enum("secondment_status", [...secondmentStatuses]);

export const secondmentStatusZodEnum = createSelectSchema(secondmentStatusEnum);
