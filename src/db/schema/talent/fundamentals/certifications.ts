...
export const certificationStatusEnum = talentSchema.enum("certification_status", [...certificationStatuses]);
...
export const certificationInsertSchema = createInsertSchema(certifications, {
  certificationCode: z.string().min(2).max(50).regex(/^[A-Z0-9_-]+$/i, "Only alphanumeric, underscore, and hyphen allowed"),
