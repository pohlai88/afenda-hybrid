CREATE SCHEMA IF NOT EXISTS "payroll";--> statement-breakpoint
CREATE SCHEMA IF NOT EXISTS "benefits";--> statement-breakpoint
CREATE SCHEMA IF NOT EXISTS "talent";--> statement-breakpoint
CREATE SCHEMA IF NOT EXISTS "learning";--> statement-breakpoint
CREATE SCHEMA IF NOT EXISTS "recruitment";--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'currency_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'core')) THEN
    CREATE TYPE "core"."currency_status" AS ENUM('ACTIVE', 'INACTIVE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'legal_entity_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'core')) THEN
    CREATE TYPE "core"."legal_entity_status" AS ENUM('ACTIVE', 'INACTIVE', 'DISSOLVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'cost_center_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'core')) THEN
    CREATE TYPE "core"."cost_center_status" AS ENUM('ACTIVE', 'INACTIVE', 'CLOSED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'actor_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit')) THEN
    CREATE TYPE "audit"."actor_type" AS ENUM('USER', 'SERVICE_PRINCIPAL', 'SYSTEM', 'ANONYMOUS');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'archive_destination' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit')) THEN
    CREATE TYPE "audit"."archive_destination" AS ENUM('S3', 'GCS', 'AZURE_BLOB', 'LOCAL', 'NONE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'retention_execution_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit')) THEN
    CREATE TYPE "audit"."retention_execution_status" AS ENUM('RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'retention_policy_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit')) THEN
    CREATE TYPE "audit"."retention_policy_status" AS ENUM('ACTIVE', 'PAUSED', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'gender' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."gender" AS ENUM('MALE', 'FEMALE', 'NON_BINARY', 'PREFER_NOT_TO_SAY', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'marital_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."marital_status" AS ENUM('SINGLE', 'MARRIED', 'DIVORCED', 'WIDOWED', 'SEPARATED', 'DOMESTIC_PARTNERSHIP', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'person_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."person_status" AS ENUM('ACTIVE', 'INACTIVE', 'DECEASED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'name_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."name_type" AS ENUM('LEGAL', 'PREFERRED', 'FORMER', 'MAIDEN', 'ALIAS');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'contact_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."contact_type" AS ENUM('EMAIL', 'PHONE', 'MOBILE', 'WORK_PHONE', 'WORK_EMAIL', 'FAX', 'SOCIAL');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'address_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."address_type" AS ENUM('RESIDENTIAL', 'MAILING', 'EMERGENCY', 'WORK', 'TEMPORARY');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'identifier_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."identifier_type" AS ENUM('PASSPORT', 'TAX_ID', 'SSN', 'NATIONAL_ID', 'DRIVER_LICENSE', 'WORK_PERMIT', 'VISA', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'emergency_relationship' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."emergency_relationship" AS ENUM('SPOUSE', 'PARENT', 'CHILD', 'SIBLING', 'RELATIVE', 'FRIEND', 'COLLEAGUE', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'dependent_relationship' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."dependent_relationship" AS ENUM('SPOUSE', 'CHILD', 'PARENT', 'DOMESTIC_PARTNER', 'STEPCHILD', 'FOSTER_CHILD', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'dependent_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."dependent_status" AS ENUM('ACTIVE', 'INACTIVE', 'DECEASED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'document_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."document_status" AS ENUM('ACTIVE', 'ARCHIVED', 'EXPIRED', 'PENDING_REVIEW');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'document_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."document_type" AS ENUM('ID_CARD', 'PASSPORT_COPY', 'VISA_COPY', 'WORK_PERMIT', 'CONTRACT', 'CERTIFICATE', 'DEGREE', 'RESUME', 'PHOTO', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'department_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."department_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'position_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."position_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED', 'FROZEN');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'job_family_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."job_family_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'job_role_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."job_role_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'job_grade_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."job_grade_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'contract_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."contract_status" AS ENUM('DRAFT', 'ACTIVE', 'EXPIRED', 'TERMINATED', 'SUSPENDED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'contract_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."contract_type" AS ENUM('PERMANENT', 'FIXED_TERM', 'CONTRACTOR', 'INTERN', 'TEMPORARY', 'PART_TIME', 'PROBATIONARY');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'probation_outcome' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."probation_outcome" AS ENUM('PENDING', 'PASSED', 'EXTENDED', 'FAILED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'notice_initiator' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."notice_initiator" AS ENUM('EMPLOYEE', 'EMPLOYER', 'MUTUAL');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'notice_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."notice_status" AS ENUM('PENDING', 'ACTIVE', 'COMPLETED', 'WITHDRAWN', 'WAIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'report_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."report_type" AS ENUM('DIRECT', 'DOTTED', 'FUNCTIONAL', 'ADMINISTRATIVE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'transfer_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."transfer_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'COMPLETED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'transfer_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."transfer_type" AS ENUM('DEPARTMENT', 'LOCATION', 'POSITION', 'LATERAL', 'PROMOTION', 'DEMOTION');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'secondment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."secondment_status" AS ENUM('PENDING', 'ACTIVE', 'COMPLETED', 'CANCELLED', 'EXTENDED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'schedule_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."schedule_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'schedule_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."schedule_type" AS ENUM('FIXED', 'ROTATING', 'FLEXIBLE', 'COMPRESSED', 'SPLIT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'timesheet_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."timesheet_status" AS ENUM('DRAFT', 'SUBMITTED', 'APPROVED', 'REJECTED', 'PROCESSED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'overtime_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."overtime_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'PROCESSED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'overtime_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."overtime_type" AS ENUM('REGULAR', 'WEEKEND', 'HOLIDAY', 'NIGHT', 'EMERGENCY');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'holiday_calendar_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."holiday_calendar_status" AS ENUM('DRAFT', 'ACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'leave_type_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."leave_type_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'absence_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."absence_status" AS ENUM('RECORDED', 'EXCUSED', 'UNEXCUSED', 'CONVERTED_TO_LEAVE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'absence_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."absence_type" AS ENUM('NO_SHOW', 'EMERGENCY', 'MEDICAL', 'FAMILY', 'WEATHER', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'shift_swap_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."shift_swap_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED', 'COMPLETED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'attendance_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."attendance_type" AS ENUM('REGULAR', 'OVERTIME', 'REMOTE', 'ON_SITE', 'FIELD_WORK', 'TRAINING');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'leave_request_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."leave_request_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED', 'WITHDRAWN');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'request_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."request_category" AS ENUM('PAYROLL', 'BENEFITS', 'LEAVE', 'POLICY', 'IT_ACCESS', 'DOCUMENT', 'COMPLAINT', 'GENERAL', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'request_priority' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."request_priority" AS ENUM('LOW', 'MEDIUM', 'HIGH', 'URGENT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'request_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."request_status" AS ENUM('OPEN', 'IN_PROGRESS', 'PENDING_INFO', 'RESOLVED', 'CLOSED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'document_request_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."document_request_status" AS ENUM('PENDING', 'PROCESSING', 'READY', 'DELIVERED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'document_request_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."document_request_type" AS ENUM('EMPLOYMENT_CERTIFICATE', 'SALARY_CERTIFICATE', 'EXPERIENCE_LETTER', 'NOC', 'REFERENCE_LETTER', 'TAX_DOCUMENT', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'declaration_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."declaration_status" AS ENUM('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'VERIFIED', 'REJECTED', 'EXPIRED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'declaration_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."declaration_type" AS ENUM('TAX_DECLARATION', 'INVESTMENT_PROOF', 'RENT_DECLARATION', 'INSURANCE_PROOF', 'DEPENDENT_DECLARATION', 'COMPLIANCE_ACKNOWLEDGMENT', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'asset_condition' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."asset_condition" AS ENUM('NEW', 'GOOD', 'FAIR', 'POOR', 'DAMAGED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'asset_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."asset_type" AS ENUM('LAPTOP', 'DESKTOP', 'MOBILE', 'TABLET', 'MONITOR', 'KEYBOARD', 'MOUSE', 'HEADSET', 'ID_CARD', 'ACCESS_CARD', 'VEHICLE', 'FURNITURE', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'assignment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr')) THEN
    CREATE TYPE "hr"."assignment_status" AS ENUM('ASSIGNED', 'RETURNED', 'LOST', 'DAMAGED', 'TRANSFERRED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'compensation_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."compensation_status" AS ENUM('DRAFT', 'ACTIVE', 'SUPERSEDED', 'TERMINATED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pay_frequency' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."pay_frequency" AS ENUM('MONTHLY', 'BIWEEKLY', 'WEEKLY', 'SEMI_MONTHLY', 'ANNUAL');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pay_component_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."pay_component_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pay_component_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."pay_component_type" AS ENUM('EARNING', 'DEDUCTION', 'BENEFIT', 'REIMBURSEMENT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pay_grade_structure_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."pay_grade_structure_status" AS ENUM('DRAFT', 'ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'earnings_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."earnings_category" AS ENUM('SALARY', 'OVERTIME', 'BONUS', 'COMMISSION', 'ALLOWANCE', 'INCENTIVE', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'earnings_type_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."earnings_type_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'deduction_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."deduction_category" AS ENUM('TAX', 'SOCIAL_INSURANCE', 'PENSION', 'HEALTH_INSURANCE', 'LOAN', 'GARNISHMENT', 'UNION_DUES', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'deduction_type_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."deduction_type_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'expense_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."expense_category" AS ENUM('TRAVEL', 'MEALS', 'ACCOMMODATION', 'TRANSPORT', 'EQUIPMENT', 'COMMUNICATION', 'TRAINING', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'expense_type_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."expense_type_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'bank_account_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."bank_account_status" AS ENUM('ACTIVE', 'INACTIVE', 'CLOSED', 'PENDING_VERIFICATION');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'filing_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."filing_status" AS ENUM('SINGLE', 'MARRIED_FILING_JOINTLY', 'MARRIED_FILING_SEPARATELY', 'HEAD_OF_HOUSEHOLD', 'QUALIFYING_WIDOW');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'tax_profile_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."tax_profile_status" AS ENUM('ACTIVE', 'INACTIVE', 'SUPERSEDED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'social_insurance_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."social_insurance_status" AS ENUM('ACTIVE', 'INACTIVE', 'EXEMPT', 'PENDING');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'period_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."period_status" AS ENUM('OPEN', 'PROCESSING', 'CLOSED', 'LOCKED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'payroll_run_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."payroll_run_status" AS ENUM('DRAFT', 'CALCULATING', 'PENDING_APPROVAL', 'APPROVED', 'PROCESSING', 'COMPLETED', 'CANCELLED', 'FAILED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'entry_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."entry_type" AS ENUM('EARNING', 'DEDUCTION', 'EMPLOYER_CONTRIBUTION', 'ADJUSTMENT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'payslip_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."payslip_status" AS ENUM('DRAFT', 'GENERATED', 'SENT', 'VIEWED', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'payment_method' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."payment_method" AS ENUM('BANK_TRANSFER', 'CHECK', 'CASH', 'DIRECT_DEPOSIT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'payment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."payment_status" AS ENUM('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED', 'REVERSED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'expense_claim_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."expense_claim_status" AS ENUM('DRAFT', 'SUBMITTED', 'PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'PROCESSING', 'PAID', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'loan_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."loan_status" AS ENUM('PENDING', 'APPROVED', 'ACTIVE', 'COMPLETED', 'DEFAULTED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'loan_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."loan_type" AS ENUM('SALARY_ADVANCE', 'PERSONAL_LOAN', 'EMERGENCY_LOAN', 'HOUSING_LOAN', 'EDUCATION_LOAN', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'settlement_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'payroll')) THEN
    CREATE TYPE "payroll"."settlement_status" AS ENUM('DRAFT', 'CALCULATING', 'PENDING_APPROVAL', 'APPROVED', 'PROCESSING', 'PAID', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'plan_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."plan_status" AS ENUM('DRAFT', 'ACTIVE', 'SUSPENDED', 'DISCONTINUED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'plan_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."plan_type" AS ENUM('HEALTH_INSURANCE', 'DENTAL', 'VISION', 'LIFE_INSURANCE', 'DISABILITY', 'RETIREMENT', 'WELLNESS', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'provider_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."provider_status" AS ENUM('ACTIVE', 'INACTIVE', 'SUSPENDED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enrollment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."enrollment_status" AS ENUM('PENDING', 'ACTIVE', 'SUSPENDED', 'TERMINATED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'coverage_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."coverage_status" AS ENUM('ACTIVE', 'SUSPENDED', 'TERMINATED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'claim_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'benefits')) THEN
    CREATE TYPE "benefits"."claim_status" AS ENUM('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'APPROVED', 'PARTIALLY_APPROVED', 'REJECTED', 'PAID', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'skill_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."skill_category" AS ENUM('TECHNICAL', 'SOFT', 'LANGUAGE', 'CERTIFICATION', 'TOOL', 'DOMAIN', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'skill_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."skill_status" AS ENUM('ACTIVE', 'INACTIVE', 'DEPRECATED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'certification_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."certification_status" AS ENUM('ACTIVE', 'INACTIVE', 'DEPRECATED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'framework_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."framework_status" AS ENUM('DRAFT', 'ACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pool_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."pool_status" AS ENUM('ACTIVE', 'INACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'proficiency_level' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."proficiency_level" AS ENUM('BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'EXPERT', 'MASTER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'review_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."review_status" AS ENUM('DRAFT', 'SELF_ASSESSMENT', 'MANAGER_REVIEW', 'CALIBRATION', 'COMPLETED', 'ACKNOWLEDGED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'review_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."review_type" AS ENUM('ANNUAL', 'SEMI_ANNUAL', 'QUARTERLY', 'PROBATION', 'PROJECT', 'AD_HOC');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'goal_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."goal_status" AS ENUM('DRAFT', 'ACTIVE', 'ON_TRACK', 'AT_RISK', 'BEHIND', 'COMPLETED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'goal_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."goal_type" AS ENUM('INDIVIDUAL', 'TEAM', 'DEPARTMENT', 'COMPANY', 'DEVELOPMENT');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'promotion_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."promotion_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'COMPLETED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'readiness_level' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."readiness_level" AS ENUM('READY_NOW', 'READY_1_YEAR', 'READY_2_YEARS', 'DEVELOPMENT_NEEDED', 'NOT_READY');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'succession_plan_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."succession_plan_status" AS ENUM('DRAFT', 'ACTIVE', 'UNDER_REVIEW', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'disciplinary_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."disciplinary_status" AS ENUM('DRAFT', 'ISSUED', 'ACKNOWLEDGED', 'APPEALED', 'RESOLVED', 'EXPIRED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'disciplinary_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."disciplinary_type" AS ENUM('VERBAL_WARNING', 'WRITTEN_WARNING', 'FINAL_WARNING', 'SUSPENSION', 'DEMOTION', 'TERMINATION', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'grievance_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."grievance_status" AS ENUM('SUBMITTED', 'UNDER_INVESTIGATION', 'PENDING_RESOLUTION', 'RESOLVED', 'ESCALATED', 'CLOSED', 'WITHDRAWN');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'grievance_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'talent')) THEN
    CREATE TYPE "talent"."grievance_type" AS ENUM('HARASSMENT', 'DISCRIMINATION', 'WORKPLACE_SAFETY', 'POLICY_VIOLATION', 'MANAGEMENT', 'COMPENSATION', 'WORKING_CONDITIONS', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'course_format' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."course_format" AS ENUM('CLASSROOM', 'ONLINE', 'BLENDED', 'SELF_PACED', 'WORKSHOP', 'WEBINAR', 'ON_THE_JOB');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'course_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."course_status" AS ENUM('DRAFT', 'ACTIVE', 'SUSPENDED', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'module_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."module_status" AS ENUM('DRAFT', 'ACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'trainer_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."trainer_status" AS ENUM('ACTIVE', 'INACTIVE', 'ON_LEAVE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'trainer_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."trainer_type" AS ENUM('INTERNAL', 'EXTERNAL', 'VENDOR');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'path_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."path_status" AS ENUM('DRAFT', 'ACTIVE', 'ARCHIVED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'session_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."session_status" AS ENUM('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'POSTPONED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'training_enrollment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."training_enrollment_status" AS ENUM('PENDING', 'APPROVED', 'ENROLLED', 'ATTENDED', 'COMPLETED', 'NO_SHOW', 'CANCELLED', 'WAITLISTED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'assessment_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."assessment_status" AS ENUM('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'GRADED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'assessment_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."assessment_type" AS ENUM('QUIZ', 'EXAM', 'PRACTICAL', 'PROJECT', 'PRESENTATION', 'CERTIFICATION_EXAM');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'award_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."award_status" AS ENUM('ACTIVE', 'EXPIRED', 'REVOKED', 'PENDING_RENEWAL');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'cost_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'learning')) THEN
    CREATE TYPE "learning"."cost_category" AS ENUM('TRAINER_FEE', 'VENUE', 'MATERIALS', 'TRAVEL', 'CATERING', 'EQUIPMENT', 'CERTIFICATION', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'candidate_source' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."candidate_source" AS ENUM('JOB_BOARD', 'REFERRAL', 'CAREER_SITE', 'SOCIAL_MEDIA', 'AGENCY', 'UNIVERSITY', 'INTERNAL', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'candidate_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."candidate_status" AS ENUM('NEW', 'SCREENING', 'INTERVIEWING', 'OFFER', 'HIRED', 'REJECTED', 'WITHDRAWN', 'ON_HOLD');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'requisition_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."requisition_status" AS ENUM('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'OPEN', 'ON_HOLD', 'FILLED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'requisition_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."requisition_type" AS ENUM('NEW_POSITION', 'REPLACEMENT', 'EXPANSION', 'TEMPORARY', 'CONTRACTOR');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'application_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."application_status" AS ENUM('SUBMITTED', 'SCREENING', 'SHORTLISTED', 'INTERVIEWING', 'OFFER_PENDING', 'OFFER_EXTENDED', 'HIRED', 'REJECTED', 'WITHDRAWN');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'interview_result' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."interview_result" AS ENUM('STRONG_YES', 'YES', 'MAYBE', 'NO', 'STRONG_NO');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'interview_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."interview_status" AS ENUM('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'NO_SHOW', 'RESCHEDULED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'interview_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."interview_type" AS ENUM('PHONE_SCREEN', 'VIDEO', 'IN_PERSON', 'PANEL', 'TECHNICAL', 'BEHAVIORAL', 'FINAL');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'offer_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."offer_status" AS ENUM('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'SENT', 'ACCEPTED', 'DECLINED', 'NEGOTIATING', 'EXPIRED', 'WITHDRAWN');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'check_result' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."check_result" AS ENUM('CLEAR', 'FLAGGED', 'DISCREPANCY', 'FAILED', 'INCONCLUSIVE');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'check_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."check_status" AS ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'FAILED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'check_type' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."check_type" AS ENUM('IDENTITY', 'EMPLOYMENT', 'EDUCATION', 'CRIMINAL', 'CREDIT', 'REFERENCE', 'DRUG_TEST', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'task_category' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."task_category" AS ENUM('DOCUMENTATION', 'IT_SETUP', 'TRAINING', 'COMPLIANCE', 'INTRODUCTION', 'EQUIPMENT', 'ACCESS', 'OTHER');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'onboarding_task_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."onboarding_task_status" AS ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'BLOCKED', 'SKIPPED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'evaluation_outcome' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."evaluation_outcome" AS ENUM('PASS', 'EXTEND', 'FAIL', 'PENDING');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'evaluation_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'recruitment')) THEN
    CREATE TYPE "recruitment"."evaluation_status" AS ENUM('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    WHERE enumlabel = 'TRUNCATE' 
    AND enumtypid = (SELECT oid FROM pg_type WHERE typname = 'audit_operation' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit'))
  ) THEN
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'TRUNCATE';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'LOGIN';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'LOGOUT';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_enum 
    WHERE enumlabel = 'ACCESS' 
    AND enumtypid = (SELECT oid FROM pg_type WHERE typname = 'audit_operation' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit'))
  ) THEN
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'ACCESS';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'EXPORT';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'GRANT';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_enum 
    WHERE enumlabel = 'REVOKE' 
    AND enumtypid = (SELECT oid FROM pg_type WHERE typname = 'audit_operation' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit'))
  ) THEN
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'REVOKE';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_enum 
    WHERE enumlabel = 'CONFIG_CHANGE' 
    AND enumtypid = (SELECT oid FROM pg_type WHERE typname = 'audit_operation' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'audit'))
  ) THEN
    ALTER TYPE "audit"."audit_operation" ADD VALUE 'CONFIG_CHANGE';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    AND enumtypid = (SELECT oid FROM pg_type WHERE typname = 'employee_status' AND typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'hr'))
  ) THEN
    ALTER TYPE "hr"."employee_status" ADD VALUE 'SUSPENDED' BEFORE 'PENDING';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TYPE "hr"."employee_status" ADD VALUE 'PROBATION';
  END IF;
END $$;--> statement-breakpoint
--> statement-breakpoint
...
ALTER TABLE "audit"."audit_trail" DROP CONSTRAINT IF EXISTS "audit_trail_tenantId_tenants_tenantId_fkey";--> statement-breakpoint
ALTER TABLE "hr"."employees" DROP CONSTRAINT IF EXISTS "employees_tenantId_tenants_tenantId_fkey";--> statement-breakpoint
DROP INDEX IF EXISTS "audit"."idx_audit_trail_tenant_date";--> statement-breakpoint
DROP INDEX IF EXISTS "audit"."idx_audit_trail_table";--> statement-breakpoint
DROP INDEX IF EXISTS "hr"."uq_employees_email";--> statement-breakpoint
