...
CREATE TYPE "audit"."audit_operation" AS ENUM('INSERT', 'UPDATE', 'DELETE', 'TRUNCATE', 'LOGIN', 'LOGOUT', 'ACCESS', 'EXPORT', 'GRANT', 'REVOKE', 'CONFIG_CHANGE');--> statement-breakpoint
...
CREATE TYPE "hr"."employee_status" AS ENUM('ACTIVE', 'ON_LEAVE', 'TERMINATED', 'SUSPENDED', 'PENDING', 'PROBATION');--> statement-breakpoint
...
CREATE TYPE "payroll"."statutory_scheme_category" AS ENUM('PENSION', 'HEALTH', 'UNEMPLOYMENT', 'DISABILITY', 'LEVY', 'OTHER');--> statement-breakpoint
...
CREATE TYPE "payroll"."tax_regime" AS ENUM('US_FEDERAL', 'MY_LHDN', 'GENERIC', 'OTHER');--> statement-breakpoint
...
CREATE TYPE "benefits"."benefit_coverage_level" AS ENUM('EMPLOYEE_ONLY', 'EMPLOYEE_PLUS_PARTNER', 'EMPLOYEE_PLUS_CHILDREN', 'FAMILY', 'CUSTOM');--> statement-breakpoint
...
CREATE TYPE "recruitment"."expected_salary_period" AS ENUM('MONTHLY', 'BIWEEKLY', 'WEEKLY', 'SEMI_MONTHLY', 'ANNUAL');--> statement-breakpoint
...
CREATE TABLE "audit"."audit_trail" (
	...
	"actorId" integer,
	"actorType" "audit"."actor_type" DEFAULT 'USER'::"audit"."actor_type" NOT NULL,
	...
	"tenantId" integer NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "chk_audit_data_ops_have_table" CHECK ("operation" NOT IN ('INSERT', 'UPDATE', 'DELETE', 'TRUNCATE') OR "tableName" IS NOT NULL),
	CONSTRAINT "chk_audit_update_has_columns" CHECK ("operation" != 'UPDATE' OR "affectedColumns" IS NOT NULL),
	CONSTRAINT "chk_audit_source_location_format" CHECK ("sourceLocation" IS NULL OR "sourceLocation" ~ '^[A-Z]{2}(-[A-Z0-9]{1,3})?$')
);
--> statement-breakpoint
...
CREATE TABLE "hr"."employees" (
	...
	"createdBy" integer NOT NULL,
	"updatedBy" integer NOT NULL,
	CONSTRAINT "chk_employees_hire_date" CHECK ("hireDate" >= '1900-01-01'),
	CONSTRAINT "chk_employees_termination_after_hire" CHECK ("terminationDate" IS NULL OR "terminationDate" >= "hireDate"),
	CONSTRAINT "chk_employees_terminated_status" CHECK ("status" != 'TERMINATED' OR "terminationDate" IS NOT NULL)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "payroll"."statutory_schemes" (
	"statutorySchemeId" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payroll"."statutory_schemes_statutorySchemeId_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"schemeCode" text NOT NULL,
	"name" text NOT NULL,
	"country" text NOT NULL,
	"category" "payroll"."statutory_scheme_category" NOT NULL,
	"authority" text,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	"deletedAt" timestamp with time zone
...
--> statement-breakpoint
CREATE TABLE "payroll"."statutory_scheme_rates" (
	"statutorySchemeRateId" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "payroll"."statutory_scheme_rates_statutorySchemeRateId_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"statutorySchemeId" integer NOT NULL,
	"effectiveFrom" date NOT NULL,
	"effectiveTo" date,
	"employeeRate" numeric(5,4) NOT NULL,
	"employerRate" numeric(5,4) NOT NULL,
	"wageCeiling" numeric(14,2),
	"wageFloor" numeric(14,2),
	"rateMetadata" jsonb,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	"deletedAt" timestamp with time zone,
	CONSTRAINT "chk_statutory_scheme_rates_employee" CHECK ("employeeRate" >= 0 AND "employeeRate" <= 1),
	CONSTRAINT "chk_statutory_scheme_rates_employer" CHECK ("employerRate" >= 0 AND "employerRate" <= 1),
	CONSTRAINT "chk_statutory_scheme_rates_effective" CHECK ("effectiveTo" IS NULL OR "effectiveTo" >= "effectiveFrom")
);
--> statement-breakpoint
...
CREATE TABLE "payroll"."pay_components" (
	...
	"createdBy" integer NOT NULL,
	"updatedBy" integer NOT NULL,
	CONSTRAINT "chk_pay_components_single_master" CHECK (NOT ("earningsTypeId" IS NOT NULL AND "deductionTypeId" IS NOT NULL))
);
--> statement-breakpoint
...
CREATE TABLE "payroll"."tax_profiles" (
	...
	"taxJurisdictionCountry" varchar(2) DEFAULT 'US' NOT NULL,
	"taxRegime" "payroll"."tax_regime" DEFAULT 'US_FEDERAL'::"payroll"."tax_regime" NOT NULL,
	"regimePayload" jsonb,
	"taxIdNumber" text,
...
CREATE TABLE "payroll"."social_insurance_profiles" (
	...
	"createdBy" integer NOT NULL,
	"updatedBy" integer NOT NULL,
	CONSTRAINT "chk_social_insurance_profiles_scheme_or_name" CHECK (("statutorySchemeId" IS NOT NULL) OR ("schemeName" IS NOT NULL AND length(trim("schemeName")) > 0)),
...
CREATE TABLE "benefits"."benefit_enrollments" (
	...
	"coverageLevel" "benefits"."benefit_coverage_level",
...
CREATE TABLE "recruitment"."candidates" (
	...
	"currentTitle" text,
	"expectedSalary" text,
	"expectedSalaryAmount" numeric(14,2),
	"expectedSalaryCurrencyId" integer,
	"expectedSalaryPeriod" "recruitment"."expected_salary_period",
	"availableFrom" date,
	"personId" integer,
...
CREATE INDEX "idx_employees_payroll_legal_entity" ON "hr"."employees" ("tenantId","payrollLegalEntityId");--> statement-breakpoint
...
CREATE INDEX "idx_statutory_schemes_country" ON "payroll"."statutory_schemes" ("country");--> statement-breakpoint
CREATE INDEX "idx_statutory_schemes_category" ON "payroll"."statutory_schemes" ("category");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_statutory_schemes_country_code" ON "payroll"."statutory_schemes" (lower("country"),lower("schemeCode")) WHERE "deletedAt" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_statutory_scheme_rates_scheme" ON "payroll"."statutory_scheme_rates" ("statutorySchemeId");--> statement-breakpoint
CREATE INDEX "idx_statutory_scheme_rates_effective" ON "payroll"."statutory_scheme_rates" ("statutorySchemeId","effectiveFrom");--> statement-breakpoint
...
CREATE INDEX "idx_pay_components_earnings_type" ON "payroll"."pay_components" ("tenantId","earningsTypeId");--> statement-breakpoint
CREATE INDEX "idx_pay_components_deduction_type" ON "payroll"."pay_components" ("tenantId","deductionTypeId");--> statement-breakpoint
...
CREATE INDEX "idx_tax_profiles_regime" ON "payroll"."tax_profiles" ("tenantId","taxRegime");--> statement-breakpoint
CREATE INDEX "idx_tax_profiles_country" ON "payroll"."tax_profiles" ("tenantId","taxJurisdictionCountry");--> statement-breakpoint
...
CREATE INDEX "idx_social_insurance_profiles_scheme" ON "payroll"."social_insurance_profiles" ("tenantId","statutorySchemeId");--> statement-breakpoint
CREATE INDEX "idx_social_insurance_profiles_legal_entity" ON "payroll"."social_insurance_profiles" ("tenantId","legalEntityId");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_social_insurance_profiles_active_scheme" ON "payroll"."social_insurance_profiles" ("tenantId","employeeId","statutorySchemeId") WHERE "deletedAt" IS NULL AND "status" = 'ACTIVE' AND "effectiveTo" IS NULL AND "statutorySchemeId" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_social_insurance_profiles_active_legacy_name" ON "payroll"."social_insurance_profiles" ("tenantId","employeeId",lower("schemeName")) WHERE "deletedAt" IS NULL AND "status" = 'ACTIVE' AND "effectiveTo" IS NULL AND "statutorySchemeId" IS NULL;--> statement-breakpoint
...
CREATE INDEX "idx_payroll_periods_legal_entity" ON "payroll"."payroll_periods" ("tenantId","legalEntityId");--> statement-breakpoint
...
CREATE INDEX "idx_payroll_runs_legal_entity" ON "payroll"."payroll_runs" ("tenantId","legalEntityId");--> statement-breakpoint
...
CREATE INDEX "idx_payroll_entries_statutory_scheme" ON "payroll"."payroll_entries" ("tenantId","statutorySchemeId");--> statement-breakpoint
...
ALTER TABLE "hr"."employees" ADD CONSTRAINT "fk_employees_tenant" FOREIGN KEY ("tenantId") REFERENCES "core"."tenants"("tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "hr"."employees" ADD CONSTRAINT "fk_employees_payroll_legal_entity" FOREIGN KEY ("payrollLegalEntityId") REFERENCES "core"."legal_entities"("legalEntityId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."statutory_scheme_rates" ADD CONSTRAINT "fk_statutory_scheme_rates_scheme" FOREIGN KEY ("statutorySchemeId") REFERENCES "payroll"."statutory_schemes"("statutorySchemeId") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."pay_components" ADD CONSTRAINT "fk_pay_components_earnings_type" FOREIGN KEY ("earningsTypeId") REFERENCES "payroll"."earnings_types"("earningsTypeId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "payroll"."pay_components" ADD CONSTRAINT "fk_pay_components_deduction_type" FOREIGN KEY ("deductionTypeId") REFERENCES "payroll"."deduction_types"("deductionTypeId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."social_insurance_profiles" ADD CONSTRAINT "fk_social_insurance_profiles_statutory_scheme" FOREIGN KEY ("statutorySchemeId") REFERENCES "payroll"."statutory_schemes"("statutorySchemeId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "payroll"."social_insurance_profiles" ADD CONSTRAINT "fk_social_insurance_profiles_legal_entity" FOREIGN KEY ("legalEntityId") REFERENCES "core"."legal_entities"("legalEntityId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."payroll_periods" ADD CONSTRAINT "fk_payroll_periods_legal_entity" FOREIGN KEY ("legalEntityId") REFERENCES "core"."legal_entities"("legalEntityId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."payroll_runs" ADD CONSTRAINT "fk_payroll_runs_legal_entity" FOREIGN KEY ("legalEntityId") REFERENCES "core"."legal_entities"("legalEntityId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "payroll"."payroll_entries" ADD CONSTRAINT "fk_payroll_entries_statutory_scheme" FOREIGN KEY ("statutorySchemeId") REFERENCES "payroll"."statutory_schemes"("statutorySchemeId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
...
ALTER TABLE "recruitment"."candidates" ADD CONSTRAINT "fk_candidates_expected_salary_currency" FOREIGN KEY ("expectedSalaryCurrencyId") REFERENCES "core"."currencies"("currencyId") ON DELETE RESTRICT ON UPDATE CASCADE;--> statement-breakpoint
