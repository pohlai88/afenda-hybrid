 ...
 * Run: pnpm vitest run --config vitest.db.config.ts src/db/__tests__/applications-tenant-consistency.test.ts
 */
...
describe.skipIf(!process.env.DATABASE_URL)("applications create — tenant consistency (service)", () => {
