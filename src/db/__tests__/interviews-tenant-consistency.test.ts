 ...
 * Run: pnpm vitest run --config vitest.db.config.ts src/db/__tests__/interviews-tenant-consistency.test.ts
 */
...
describe.skipIf(!process.env.DATABASE_URL)("interviews create — tenant consistency (service)", () => {
