 ...
 * Run: pnpm vitest run --config vitest.db.config.ts src/db/__tests__/benefit-plans-zod.test.ts
 */
import { describe, expect, it } from "vitest";
import { benefitPlanInsertSchema, benefitPlanUpdateSchema } from "../schema-hrm/benefits/fundamentals/benefitPlans";
...
describe("benefit plan Zod schemas", () => {
  describe("benefitPlanInsertSchema — enums", () => {
    it("rejects invalid planType", () => {
      expectInvalidEnumField(benefitPlanInsertSchema, validInsertBase, "planType", "AUTO_INSURANCE");
    });
