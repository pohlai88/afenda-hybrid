 ...
 * Run: pnpm vitest run --config vitest.db.config.ts src/db/__tests__/recruitment-enums-zod.test.ts
 */
...
import { jobRequisitionInsertSchema, jobRequisitionUpdateSchema } from "../schema-hrm/recruitment/operations/jobRequisitions";
import { backgroundCheckInsertSchema, backgroundCheckUpdateSchema } from "../schema-hrm/recruitment/operations/backgroundChecks";
import { exitInterviewInsertSchema, exitInterviewUpdateSchema } from "../schema-hrm/recruitment/operations/exitInterviews";
import { candidateInsertSchema, candidateUpdateSchema } from "../schema-hrm/recruitment/fundamentals/candidates";
