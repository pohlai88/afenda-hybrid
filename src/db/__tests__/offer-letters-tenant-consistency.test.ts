 ...
 * Run: pnpm vitest run --config vitest.db.config.ts src/db/__tests__/offer-letters-tenant-consistency.test.ts
 */
...
describe.skipIf(!process.env.DATABASE_URL)("offer_letters create — tenant consistency (service)", () => {
