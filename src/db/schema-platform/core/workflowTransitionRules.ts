 ...
 */
export const workflowRuleOperators = ["EQUALS", "NOT_EQUALS", "GREATER_THAN", "LESS_THAN", "CONTAINS", "IN"] as const;

export const workflowRuleOperatorEnum = coreSchema.enum("workflow_rule_operator", [...workflowRuleOperators]);
...
export const WorkflowTransitionRuleIdSchema = z.number().int().positive().brand<"WorkflowTransitionRuleId">();
