...
export const notificationDeliveryStatusEnum = coreSchema.enum("notification_delivery_status", [...notificationDeliveryStatuses]);
...
export const NotificationDeliveryIdSchema = z.number().int().positive().brand<"NotificationDeliveryId">();
