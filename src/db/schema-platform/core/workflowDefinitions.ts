...
export const workflowDefinitionStatusEnum = coreSchema.enum("workflow_definition_status", [...workflowDefinitionStatuses]);
...
export const WorkflowDefinitionIdSchema = z.number().int().positive().brand<"WorkflowDefinitionId">();
