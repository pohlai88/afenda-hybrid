 ...
 * Note: userId FK added via custom SQL to avoid circular dependencies.
 */
...
export const NotificationSubscriptionIdSchema = z.number().int().positive().brand<"NotificationSubscriptionId">();
