 ...
 */
export const payrollCorrectionStatuses = ["DRAFT", "SUBMITTED", "APPROVED", "APPLIED", "REJECTED"] as const;

export const payrollCorrectionStatusEnum = payrollSchema.enum("payroll_correction_status", [...payrollCorrectionStatuses]);
