...
export const taxExemptionCategoryStatusEnum = payrollSchema.enum("tax_exemption_category_status", [...taxExemptionCategoryStatuses]);
...
export const TaxExemptionCategoryIdSchema = z.number().int().positive().brand<"TaxExemptionCategoryId">();
