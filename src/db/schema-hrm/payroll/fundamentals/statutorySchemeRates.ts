import { integer, date, numeric, jsonb, index, uniqueIndex, foreignKey, check } from "drizzle-orm/pg-core";
...
export const StatutorySchemeRateIdSchema = z.number().int().positive().brand<"StatutorySchemeRateId">();
