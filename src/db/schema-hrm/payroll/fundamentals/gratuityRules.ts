...
export const gratuityRuleStatusEnum = payrollSchema.enum("gratuity_rule_status", [...gratuityRuleStatuses]);
...
export const gratuityRuleInsertSchema = createInsertSchema(gratuityRules, {
  ...
  country: z.string().length(2).regex(/^[A-Z]{2}$/, "Must be ISO 3166-1 alpha-2 code"),
