 ...
 */
export const employeeCertificationStatuses = [
  "ACTIVE",
  "EXPIRED",
  "REVOKED",
...
export const employeeCertificationStatusEnum = talentSchema.enum("employee_certification_status", [
  ...employeeCertificationStatuses,
]);

export const employeeCertificationStatusZodEnum = createSelectSchema(
  employeeCertificationStatusEnum
);
