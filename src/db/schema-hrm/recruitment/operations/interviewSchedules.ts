 ...
 */
export const interviewScheduleStatuses = ["SCHEDULED", "CONFIRMED", "RESCHEDULED", "COMPLETED", "CANCELLED", "NO_SHOW"] as const;

export const interviewScheduleStatusEnum = recruitmentSchema.enum("interview_schedule_status", [...interviewScheduleStatuses]);
...
export const interviewSchedules = recruitmentSchema.table(
  ...
  (t) => [
    ...
    foreignKey({
      ...
      .onUpdate("cascade"),
    check(
      "chk_interview_schedules_duration",
