 ...
 */
export const roundInterviewTypes = ["PHONE", "VIDEO", "IN_PERSON", "TECHNICAL", "BEHAVIORAL", "PANEL", "CASE_STUDY"] as const;

export const roundInterviewTypeEnum = recruitmentSchema.enum("round_interview_type", [...roundInterviewTypes]);
