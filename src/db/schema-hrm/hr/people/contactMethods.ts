import { integer, text, boolean, timestamp, index, uniqueIndex, foreignKey } from "drizzle-orm/pg-core";
 ...
 */
export const contactTypes = ["EMAIL", "PHONE", "MOBILE", "WORK_PHONE", "WORK_EMAIL", "FAX", "SOCIAL"] as const;
