...
export const identifierTypeZodEnum = z.enum(identifierTypes);
...
export const nationalIdentifierInsertSchema = createInsertSchema(nationalIdentifiers, {
  ...
  refineOptionalIsoEndOnOrAfterStart(data as Record<string, unknown>, ctx, {
    startKey: "issueDate",
    endKey: "expiryDate",
    issuePath: "expiryDate",
    message: "expiryDate must be on or after issueDate when both are set",
  })
);
