 ...
 */
export const compensatoryLeaveRequestStatuses = ["PENDING", "APPROVED", "REJECTED", "EXPIRED"] as const;

export const compensatoryLeaveRequestStatusEnum = hrSchema.enum("compensatory_leave_request_status", [...compensatoryLeaveRequestStatuses]);
...
export const CompensatoryLeaveRequestIdSchema = z.number().int().positive().brand<"CompensatoryLeaveRequestId">();
