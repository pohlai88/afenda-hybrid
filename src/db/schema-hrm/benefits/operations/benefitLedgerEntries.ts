...
export const benefitLedgerEntryTypeEnum = benefitsSchema.enum("benefit_ledger_entry_type", [...benefitLedgerEntryTypes]);
...
export const BenefitLedgerEntryIdSchema = z.number().int().positive().brand<"BenefitLedgerEntryId">();
...
export const benefitLedgerEntryUpdateSchema = createUpdateSchema(benefitLedgerEntries, {
  amount: z.string().refine(isValidSignedMoney12_2, "must be valid signed numeric(12,2)").optional(),
  balance: z.string().refine(isValidSignedMoney12_2, "must be valid signed numeric(12,2)").optional(),
