 ...
 */
export const benefitApplicationStatuses = ["DRAFT", "SUBMITTED", "APPROVED", "REJECTED", "WITHDRAWN"] as const;

export const benefitApplicationStatusEnum = benefitsSchema.enum("benefit_application_status", [...benefitApplicationStatuses]);
...
export const BenefitApplicationIdSchema = z.number().int().positive().brand<"BenefitApplicationId">();
