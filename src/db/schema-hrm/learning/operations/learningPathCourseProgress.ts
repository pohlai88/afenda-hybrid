 ...
 */
export const pathCourseProgressStatuses = ["NOT_STARTED", "IN_PROGRESS", "COMPLETED", "WAIVED"] as const;
...
export const learningPathCourseProgressSelectSchema = createSelectSchema(learningPathCourseProgress);

export const learningPathCourseProgressInsertSchema = createInsertSchema(learningPathCourseProgress, {
 ...
 */
export const learningPathCourseProgressUpdateSchema = createUpdateSchema(learningPathCourseProgress, {
  status: pathCourseProgressStatusZodEnum.optional(),
