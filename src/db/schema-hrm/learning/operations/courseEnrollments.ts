import { integer, text, varchar, date, index, uniqueIndex, foreignKey, check } from "drizzle-orm/pg-core";
 ...
 */
export const courseEnrollmentStatuses = ["PENDING", "IN_PROGRESS", "COMPLETED", "CANCELLED", "EXPIRED"] as const;
