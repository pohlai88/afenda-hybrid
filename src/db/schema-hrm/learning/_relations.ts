...
export const learningRelations = defineRelations(
  ...
  (r) => ({
    ...
    learningPaths: {
      ...
      assignments: r.many.learningPathAssignments({
        from: r.learningPaths.learningPathId,
    ...
    learningPathCourses: {
      ...
      assignmentProgress: r.many.learningPathCourseProgress({
    ...
    trainingEnrollments: {
      ...
      pathCourseProgress: r.many.learningPathCourseProgress({
    ...
    courseEnrollments: {
      ...
      assigner: r.one.employees({
        ...
        to: r.employees.employeeId,
        optional: true,
        alias: "course_enrollment_assigner",
      }),
      pathCourseProgress: r.many.learningPathCourseProgress({
