...
- **Related schema files**: (e.g., src/db/schema/audit/auditTrail.ts)
...
- [ ] Will add entry to `src/db/schema/audit/CUSTOM_SQL_REGISTRY.json`
- [ ] Will document in `src/db/schema/audit/CUSTOM_SQL.md` (if detailed explanation needed)
