 ...
 *   pnpm db:apply-rls
 *   pnpm --filter @afenda/db run db:apply-rls -- --dry-run
 *
 * From `packages/db`: `pnpm db:apply-rls` / `pnpm exec tsx scripts/prepare/apply-rls.ts --dry-run`.
 *
...
const TENANT_SCOPED_TABLES: TableConfig[] = [
  ...
  {
    schema: "payroll",
    table: "social_insurance_profiles",
    tenantIdColumn: "tenantId",
    policyName: "tenant_isolation",
  },
  {
    schema: "payroll",
    table: "compensation_packages",
    tenantIdColumn: "tenantId",
    policyName: "tenant_isolation",
  },
  {
  ...
  {
    schema: "talent",
    table: "performance_review_goals",
    tenantIdColumn: "tenantId",
    policyName: "tenant_isolation",
  },
  {
  ...
  {
    schema: "learning",
    table: "learning_path_assignments",
    tenantIdColumn: "tenantId",
    policyName: "tenant_isolation",
  },
  {
  ...
  {
    schema: "recruitment",
    table: "candidate_salary_backfill_issues",
    tenantIdColumn: "tenantId",
    policyName: "tenant_isolation",
  },
];
