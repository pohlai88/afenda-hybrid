...
function main(): void {
  ...
  checkFile("src/schema-platform/index.ts", "Schema Entry Point");
  ...
  checkFile("scripts/ci/validate-migrations.ts", "Migration Validator");
  checkFile("scripts/ci/detect-schema-drift.ts", "Drift Detector");

  // 10. Check documentation
  checkFile("docs/SCHEMA_LOCKDOWN.md", "Schema Lockdown Guide");
  checkFile("src/schema-platform/audit/CUSTOM_SQL_REGISTRY.json", "Custom SQL Registry");
