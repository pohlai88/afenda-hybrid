 ...
 *
 * @see docs/preflight/preflight-succession-plans-lifecycle.sql
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    if (a > 0 || b > 0 || c > 0) {
      console.error(
        "Succession plans preflight failed. See docs/preflight/preflight-succession-plans-lifecycle.sql"
      );
      process.exit(1);
    }
  } finally {
