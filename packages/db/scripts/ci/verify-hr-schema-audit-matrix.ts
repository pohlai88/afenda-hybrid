/**
 * Ensures docs/hcm/hr-schema-audit-matrix.md:
 ...
 * CI test: src/__tests__/hr-schema-audit-matrix.test.ts
 *
...
const MATRIX_PATH = path.join(process.cwd(), "../../docs/hcm/hr-schema-audit-matrix.md");
...
function main(): void {
  ...
  console.log(
    "OK: hr-schema-audit-matrix.md passed verification (row count, talent, recruitment)."
  );
}
