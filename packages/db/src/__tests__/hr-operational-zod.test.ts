 ...
 * Run: pnpm test:db -- src/__tests__/hr-operational-zod.test.ts
 */
...
import { employeeTransferInsertSchema } from "../schema-hrm/hr/employment/employeeTransfers";
import {
...
import {
  ...
  absenceRecordUpdateSchema,
} from "../schema-hrm/hr/time/absenceRecords";
import {
