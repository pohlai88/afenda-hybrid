/**
 * Keeps docs/hcm/hr-schema-audit-matrix.md aligned with REQUIRED_TALENT_TABLES and REQUIRED_RECRUITMENT_TABLES.
 * Run: pnpm test:db -- src/__tests__/hr-schema-audit-matrix.test.ts
