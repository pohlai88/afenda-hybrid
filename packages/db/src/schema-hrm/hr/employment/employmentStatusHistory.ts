...
import { dateStringSchema, hrBounds } from "../_zodShared";
import { appendOnlyTimestampColumns } from "../../../_shared";
import { tenants } from "../../../schema-platform/core/tenants";
import { employeeStatusEnum, employeeStatusZodEnum } from "../fundamentals/employees";
...
export const EmploymentStatusHistoryIdSchema = z
  .number()
  .int()
  .brand<"EmploymentStatusHistoryId">();
...
export const employmentStatusHistoryInsertSchema = createInsertSchema(employmentStatusHistory, {
  ...
  newStatus: employeeStatusZodEnum,
  previousStatus: employeeStatusZodEnum.optional(),
