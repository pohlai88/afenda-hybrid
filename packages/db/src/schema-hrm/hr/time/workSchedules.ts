...
import { nullableOptional, weeklyHours41StringSchema } from "../_zodShared";
...
export const scheduleTypeZodEnum = z.enum(scheduleTypes);
...
export const scheduleStatusZodEnum = z.enum(scheduleStatuses);
...
export const workScheduleInsertSchema = createInsertSchema(workSchedules, {
  ...
  weeklyHours: weeklyHours41StringSchema.optional(),
...
export const workScheduleUpdateSchema = createUpdateSchema(workSchedules, {
  ...
  weeklyHours: nullableOptional(weeklyHours41StringSchema),
