...
export const holidayCalendarStatusEnum = hrSchema.enum("holiday_calendar_status", [
  ...holidayCalendarStatuses,
]);

export const holidayCalendarStatusZodEnum = z.enum(holidayCalendarStatuses);
...
export const holidayCalendarUpdateSchema = createUpdateSchema(holidayCalendars, {
  ...
  regionId: nullableOptional(z.number().int()),
