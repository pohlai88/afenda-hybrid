...
import { zMoney12_2NonNegative } from "../_zodShared";
...
export const TaxExemptionDeclarationEntryIdSchema = z
  .number()
  .int()
  .positive()
  .brand<"TaxExemptionDeclarationEntryId">();
export type TaxExemptionDeclarationEntryId = z.infer<typeof TaxExemptionDeclarationEntryIdSchema>;

export const taxExemptionDeclarationEntrySelectSchema = createSelectSchema(
  taxExemptionDeclarationEntries
);

export const taxExemptionDeclarationEntryInsertSchema = createInsertSchema(
  taxExemptionDeclarationEntries,
  {
...
export const taxExemptionDeclarationEntryUpdateSchema = createUpdateSchema(
  taxExemptionDeclarationEntries,
  {
