...
export const taxDeclarationStatusEnum = payrollSchema.enum("tax_declaration_status", [
...
export const TaxExemptionDeclarationIdSchema = z
  .number()
  .int()
  .positive()
  .brand<"TaxExemptionDeclarationId">();
