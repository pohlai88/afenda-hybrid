...
export const payComponentTypeEnum = payrollSchema.enum("pay_component_type", [
  ...payComponentTypes,
]);
...
export const payComponentStatusEnum = payrollSchema.enum("pay_component_status", [
  ...payComponentStatuses,
]);
