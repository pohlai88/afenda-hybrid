...
export const socialInsuranceStatusEnum = payrollSchema.enum("social_insurance_status", [
  ...socialInsuranceStatuses,
]);
...
export const SocialInsuranceProfileIdSchema = z
  .number()
  .int()
  .positive()
  .brand<"SocialInsuranceProfileId">();
