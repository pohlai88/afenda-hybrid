...
export const interviewRecommendationEnum = recruitmentSchema.enum("interview_recommendation", [
...
export const interviewFeedbackInsertSchema = createInsertSchema(interviewFeedback, {
  ...
  rating: z
    .string()
    .refine(isValidRating, "must be valid rating 0-10 with max 2 decimals")
    .optional()
    .nullable(),
