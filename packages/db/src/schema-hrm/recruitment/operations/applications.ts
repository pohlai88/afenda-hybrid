...
export const applicationStatusEnum = recruitmentSchema.enum("application_status", [
  ...applicationStatuses,
]);
...
export const applications = recruitmentSchema.table(
  ...
  (t) => [
    ...
    index("idx_applications_tenant_candidate_date").on(
      t.tenantId,
      t.candidateId,
      t.applicationDate
    ),
...
export const applicationUpdateSchema = createUpdateSchema(applications, {
  ...
  refineApplicationIdFieldsOnUpdate(row as Record<string, unknown>, ctx)
);
