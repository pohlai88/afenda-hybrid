 ...
 * Product rules: `docs/hcm/recruitment-candidate-databank.md` §0 and ADR `docs/architecture/adr/0001-candidate-hired-hr-bridge.md`.
 */
import {
  integer,
  text,
...
export const candidateSourceEnum = recruitmentSchema.enum("candidate_source", [
  ...candidateSources,
]);
...
export const candidateStatusEnum = recruitmentSchema.enum("candidate_status", [
  ...candidateStatuses,
]);
...
export const expectedSalaryPeriods = [
  "MONTHLY",
  "BIWEEKLY",
  "WEEKLY",
  "SEMI_MONTHLY",
 ...
 *
 * @see docs/hcm/recruitment-candidate-databank.md
 *
...
function refineExpectedSalaryBundle(
