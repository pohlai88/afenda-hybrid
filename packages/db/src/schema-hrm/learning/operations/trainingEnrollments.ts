 ...
 */
export const trainingEnrollmentStatuses = [
  "PENDING",
  "APPROVED",
  "ENROLLED",
  "ATTENDED",
...
export const trainingEnrollmentStatusEnum = learningSchema.enum("training_enrollment_status", [
  ...trainingEnrollmentStatuses,
]);
