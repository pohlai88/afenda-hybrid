...
- [docs/hcm/talent-schema-inventory.md](../../../../docs/hcm/talent-schema-inventory.md)
- [docs/hcm/talent-domain-boundaries.md](../../../../docs/hcm/talent-domain-boundaries.md)
- [docs/hcm/talent-management-roadmap.md](../../../../docs/hcm/talent-management-roadmap.md)

## Tests

DB contracts: `__tests__/talent-contracts.test.ts` (`pnpm test:db:contracts`).

## Changing the schema

Checklist for new or renamed tables: [docs/hcm/talent-schema-inventory.md — Adding or renaming a talent table](../../../../docs/hcm/talent-schema-inventory.md#adding-or-renaming-a-talent-table).
