...
export const workflowInstanceStatusEnum = coreSchema.enum("workflow_instance_status", [
...
export const workflowInstances = coreSchema.table(
  "workflow_instances",
  {
    ...
    // status: workflow_instance_status — ACTIVE (default), COMPLETED, CANCELLED, TIMED_OUT
