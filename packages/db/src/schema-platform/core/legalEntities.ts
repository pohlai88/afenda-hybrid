...
export const legalEntityStatusEnum = coreSchema.enum("legal_entity_status", [
  ...legalEntityStatuses,
]);
...
/**
 * Registered legal vehicle for tax and compliance (subsidiary, branch, etc.); scoped to a tenant with optional default currency.
 */
export const legalEntities = coreSchema.table(
  "legal_entities",
  {
    ...
    address: text(),
    // status: legal_entity_status — ACTIVE (default), INACTIVE, DISSOLVED
