  ...
  (r) => ({
    ...
    attachments: {
      ...
      uploadedByUser: r.one.users({
        from: r.attachments.uploadedBy,
        to: r.users.userId,
        alias: "attachments_uploader",
      }),
    },
    ...
    dashboardWidgets: {
      ...
      userPlacements: r.many.userDashboardWidgets({
        from: r.dashboardWidgets.widgetId,
        to: r.userDashboardWidgets.templateWidgetId,
      }),
    },

    userDashboardWidgets: {
      tenant: r.one.tenants({
        from: r.userDashboardWidgets.tenantId,
        to: r.tenants.tenantId,
      }),
      user: r.one.users({
        from: r.userDashboardWidgets.userId,
        to: r.users.userId,
      }),
      template: r.one.dashboardWidgets({
        from: r.userDashboardWidgets.templateWidgetId,
        to: r.dashboardWidgets.widgetId,
        optional: true,
      }),
    },
    ...
    tenants: {
      ...
      userDashboardWidgets: r.many.userDashboardWidgets({
        from: r.tenants.tenantId,
        to: r.userDashboardWidgets.tenantId,
      }),
