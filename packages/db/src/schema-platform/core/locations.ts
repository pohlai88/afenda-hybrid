...
/** Physical site or workplace; tenant-scoped, optionally linked to `regions`. */
export const locations = coreSchema.table(
  "locations",
  {
    ...
    // status: location_status — ACTIVE (default), INACTIVE, CLOSED
