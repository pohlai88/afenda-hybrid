 ...
 *
 * @see docs/preflight-learning-completion-cert-verification.sql
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    if (trainingCount > 0 || certCount > 0) {
      console.error(
        "Learning/cert lifecycle preflight failed. See docs/preflight-learning-completion-cert-verification.sql",
      );
      process.exit(1);
    }
  } finally {
